...
function ajouter_recette(){
	...
	// verif dans les recettes deja dans le menu 
	var already_in_menu = document.querySelectorAll('.opt_supprimer');
	for(var i=0; i<already_in_menu.length; i++){
		if(already_in_menu[i].id.split(',')[1] == value){
			already_selected += 1;
		}
	}
	...
	if(already_selected == 0){
		...
		document.getElementById('recettes_menu').innerHTML += value[1] +  '<br>'; // affichage des recettes sélectionnées une à une
